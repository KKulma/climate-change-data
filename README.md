...
|  DitchCarbon API | [LINK](https://docs.ditchcarbon.com/ "LINK") | carbon emissions, companies, products, activities | DitchCarbon provides API access to their dataset of company and product carbon emissions disclosures, also includes reccommended actions for each company to decarbonise. Free trial | |
...
|  Companies taking action | [LINK](https://ditchcarbon.com/free-sbti-api-access/ "LINK") | Company | API access to the "companies taking action" list from SBTI |
