...
|  Copernicus Climate Data Store API | [LINK](https://cds.climate.copernicus.eu/toolbox/doc/api.html "LINK") | atmosphere, biosphere, hydrology, ocean physics and biochemistry | wide user groups | [LINK](https://github.com/bluegreen-labs/ecmwfr "LINK") |
|  Degree Days API | [LINK](https://www.degreedays.net/api/ "LINK") | weather | Weather Data for Energy Professionals |  |
|  Eurostat API | [LINK](https://ec.europa.eu/eurostat/web/json-and-unicode-web-services "LINK") | atmosphere, biosphere, hydrology from Eurostat, the European Environment Agency (EEA), and the Commission's Joint Research Centre (JRC) | wide user groups | [LINK](https://github.com/ropengov/eurostat "LINK") |
