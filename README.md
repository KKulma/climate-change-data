...
|  Global Gridded Weather Data | https://crudata.uea.ac.uk/cru/data/hrg/ | temperature, precipitation, sun time, cloud cover, ground frost, vapour pressure, potential evapotranspiration | A large set of land weather data spanning 1901-2018, gridded into 0.5x0.5 deg squares. Data extrapolated from real weather station data. Details in: https://doi.org/10.1002/joc.3711 |
...
|  How many gigatons of CO2...? | https://informationisbeautiful.net/visualizations/how-many-gigatons-of-co2/ | CO2 emissions | Data on CO2 remaining budget - Information Is Beautiful data vis with references to underlying data sources |
|  How to reduce the worlds carbon footprint by 2050 | https://informationisbeautiful.net/visualizations/how-to-reduce-the-worlds-carbon-footprint-by-2050/ | CO2 emissions | Data on CO2 emissions - Information Is Beautiful data vis with references to underlying data sources |
|  In Deep Water - can we offorfd to spill any oil? | https://informationisbeautiful.net/2010/in-deep-water/ | oil spillage | Data on oil spillage - Information Is Beautiful data vis with references to underlying data sources |
...
|  Mega-What? | https://informationisbeautiful.net/visualizations/mega-what-the-worlds-biggest-and-most-notable-power-plants/ | energy | World's largest and notable data sources - Information Is Beautiful data vis with references to underlying data sources |
|  Methana - aka- natural gas | https://informationisbeautiful.net/visualizations/methane-or-natural-gas-the-other-major-greenhouse-gas/ | methane emissions | Data on methane emisisons - Information Is Beautiful data vis with references to underlying data sources |
