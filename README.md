...
<<<<<<< HEAD
|  Eurostat API | [LINK](https://ec.europa.eu/eurostat/web/json-and-unicode-web-services "LINK") | atmosphere, biosphere, hydrology | The European statistical networks API which provides data to various government statistics, data of the European Environment Agency (EEA) and the Commission's Joint Research Centre (JRC) | [LINK](https://github.com/ropengov/eurostat "LINK") |
=======
|  Eurostat API | [LINK](https://ec.europa.eu/eurostat/web/json-and-unicode-web-services "LINK") | atmosphere, biosphere, hydrology from Eurostat, the European Environment Agency (EEA), and the Commission's Joint Research Centre (JRC) | The European statistical networks API which provides data to various government statistics and European environmental statistical data | [LINK](https://github.com/ropengov/eurostat "LINK") |
>>>>>>> f37897b... descriptions
